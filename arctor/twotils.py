...
from astropy.modeling import models                                    #Importing models because Guassian1D
...
#     print('lc_std / lc_med * ppm', lc_std / lc_med * ppm)
#     #return lc_std / lc_med * ppm
#     #return lc_std, lc_med, ppm                                                                     #modified return


def center_one_trace(kcol, col, fitter, stddev, y_idx, inds, idx_buffer=10):
    model = models.Gaussian1D(amplitude=col.max(),                                      #Added models.
...
def fit_one_slopes(kimg, means, fitter, y_idx, slope_guess=2.0 / 466):
    model = models.Linear1D(slope=slope_guess, intercept=y_idx)
...
def run_all_12_options(times, flux, uncs,
                       ...
                       planet_name="planet_name"):                                               #I DID EDIT HERE (PLANET_NAME)
